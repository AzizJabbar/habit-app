...
class CountDownActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 10 : Set initial time and observe current time. Update button state when countdown is finished
        ...
        // 13 : Start and cancel One Time Request WorkManager to notify when time is up.
