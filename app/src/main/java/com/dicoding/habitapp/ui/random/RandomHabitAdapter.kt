...
class RandomHabitAdapter(
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        // 14 : Create view and bind data to item view
        ...
        private val tvMinutes: TextView = itemView.findViewById(R.id.tv_pager_minutes)
        private val countDownBtn: Button = itemView.findViewById(R.id.btn_count_down)
